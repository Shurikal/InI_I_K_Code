 ...
 */
public class Tiermonitor implements Custom_Things
{
    ...
    public Tiermonitor()
    {
        ...
        sichtungenHinzufuegen(Custom_Things.streamPath);
    }
    ...
    public void listeAusgebenv2(){
        Stream<Sichtung> sichtungStream = sichtungen.stream();
        sichtungStream.forEach(sichtung -> System.out.println(sichtung.gibDetails()));
    }

    public static void main(String[] args) {
        Tiermonitor t = new Tiermonitor();
        //t.listeAusgebenv2();
        t.sichtungenAusgebenUeberv2("Elephant");
    }
    ...
    public void sichtungenAusgebenUeberv2(String tier){
        //Stream<Sichtung> sichtungStream = sichtungen.stream();
        //sichtungStream = sichtungStream.filter(sichtung -> sichtung.gibTier().equals(tier));
        //sichtungStream.forEach(sichtung -> System.out.println(sichtung.gibDetails()));
        sichtungen.stream().filter(sichtung -> sichtung.gibTier().equals(tier)).forEach(sichtung -> System.out.println(sichtung.gibDetails()));
    }
