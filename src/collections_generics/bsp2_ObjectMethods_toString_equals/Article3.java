package collections_generics.bsp2_ObjectMethods_toString_equals;
...
public class Article3 {
	...
	public int hashCode() {
		//see Doku zu hashCode: Objekete, bei denen equals true liefert, m�ssen den gleichen Hashcode haben
